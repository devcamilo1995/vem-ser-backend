            ...
            <table width="600" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td align="center" valign="top" bgcolor="#d3be6c"
                        ...
                        <div>
                            <br>Ola ${nome}, <br>
                            Voce perdeu o acesso ao nosso sistema.<br> <br>

                            Qualquer dúvida é só contatar o suporte pelo e-mail ${remetente}.<br>

                            Att,<br>
                            Sistema.


                            <br> <br> <b>Nome: ${nome}, Data de nascimento: ${data}.</br>
                            <br>
                        </div>
                    </td>
                </tr>
